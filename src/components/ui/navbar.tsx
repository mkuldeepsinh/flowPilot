...
import { Building2, Menu, Home, BarChart3, FolderKanban, User, Settings, LogOut } from "lucide-react"
...
export function Navbar() {
  ...
  const navItems = [
    ...
    { name: "Finance Dashboard", href: "/dashboard", icon: BarChart3 },
    { name: "Current Projects", href: "/projects", icon: FolderKanban },
  ]
